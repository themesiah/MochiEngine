...
inline constexpr const char *CONST_WINDOW_NAME = "Space Shooter";
inline constexpr const char *CONST_DEVBUILD_TEXT = "DEVELOPMENT BUILD";
inline constexpr float CONST_DEVBUILD_TEXT_SIZE = 16.0f;

inline constexpr const char *CONST_MAIN_FONT_PATH = "Data\\Fonts\\SuperTechnology.ttf";

inline constexpr const char *CONST_TEST_IMAGE = "Data\\Coproducers.jpg";
inline const std::string CONST_ACTIONS_FILE = "Data\\Actions.json";
inline const std::string CONST_MASTER_BANK = "Master";
